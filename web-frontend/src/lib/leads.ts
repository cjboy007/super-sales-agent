...
// Repo-local sample lead corpus with env override for alternate datasets.
const DATA_PATH = resolvePath("hero-pumps", "leads", "canton-fair-leads-2026.json");

function resolveDataPath(): string {
  // In production, allow env override

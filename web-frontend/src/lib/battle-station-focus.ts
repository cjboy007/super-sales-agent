...
const TEXT = {
  en: {
    threadSummary: "Generated from live cockpit data",
    subjectPrefix: "Review required",
    signalSender: "Cockpit signal",
    jadenSender: "JadenOS Cockpit",
    ...
    approvalLine: "JadenOS is holding this item for human review before any customer-facing action.",
    approveLine: "Approve only if the recommendation, risk, and guardrail are acceptable.",
  },
  zh: {
    threadSummary: "由实时驾驶舱数据生成",
    subjectPrefix: "需要复核",
    signalSender: "驾驶舱信号",
    jadenSender: "JadenOS 驾驶舱",
    generatedNow: "刚刚生成",
    signalTitle: "最新信号",
    dealContext: "交易背景",
    approvalGate: "审批关卡",
    ...
    recommendation: "建议",
    guardrail: "护栏",
    noEvents: "当前审批还没有绑定更多时间线事件。",
    draftIntro: "内部复核记录",
    nextAction: "建议下一步",
    approvalLine: "JadenOS 正在等待人工复核，复核前不会执行任何客户可见动作。",
    approveLine: "只有在建议、风险和护栏都可接受时才批准。",
  },
} as const;

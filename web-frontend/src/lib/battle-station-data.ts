...
export const approvalRequests: ApprovalRequest[] = [
  ...
  },
  {
    ...
    guardrail: "Quote PDF generation is local only in this cockpit.",
  },
];
...
export const moduleLinks = [
  ...
  { label: "Agents", href: "/agent-status", hotkey: "A" },
...
> = {
  en: {
    copy: {
      ...
      focus: {
        ...
        reject: "Reject",
        sendGuardrail:
          "Human approval is required before any customer-facing send. This demo records approval locally only.",
        collapsedMessages:
      ...
      approvalStates: {
        ...
        "ready-after-copper": "ready-after-copper",
        "approved-by-wilson": "approved-by-wilson",
        "draft-saved": "draft-saved",
        "ai-regenerated": "ai-regenerated",
        "rejected-by-wilson": "rejected-by-wilson",
      },
      regeneratedNote:
        "Operator note: Regenerated locally for a firmer partnership tone. Confirm price floor before sending.",
    },
    domainAccounts,
    timelineEvents,
    approvalRequests,
  ...
  zh: {
    ...
    moduleLinks: [
      ...
      { label: "Agent", href: "/agent-status", hotkey: "A" },

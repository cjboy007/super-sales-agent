...
export const domainAccounts: DomainAccount[] = [
  ...
  },
  {
    ...
    lastTouch: "3m ago",
    nextAction: "Wilson confirmation required before customer-facing send",
    summary: "AI recommends 8% discount plus free shipping on >=100K meter batches with LME review clause.",
    tags: ["Review needed", "Counter-offer", "Pricing"],
  },
  {
    id: "molex",
  ...
  },
  {
    ...
    summary: "AI handled the sales process end-to-end after human pricing confirmation. Delivery ETA 2026-06-15.",
...
export const timelineEvents: TimelineEvent[] = [
  {
    ...
    tone: "safe",
    account: "TE Connectivity",
    title: "AI assistant completed RFQ analysis",
  ...
  },
  {
    ...
    tone: "pending",
    account: "Amphenol Asia",
    title: "Review required: Amphenol counter-offer",
...
export const approvalRequests: ApprovalRequest[] = [
  {
    ...
    due: "Now",
    recommendation: "Confirm 8% discount at $0.916/m with quarterly LME review.",
    guardrail: "External send is blocked until Wilson confirms this draft.",
  },
  {
    id: "molex-retention",
    dealId: "molex",
  ...
  },
  {
    ...
    recommendation: "Confirm quote package if LME stays within +3% band.",
...
export const activeAgents: ActiveAgent[] = [
  {
    ...
    tone: "safe",
    load: 0,
    currentTask: "ready for customer research",
    queue: 0,
  },
  {
    id: "outreach-drafts",
    ...
    tone: "safe",
    load: 0,
    currentTask: "ready for inbox and outreach work",
    queue: 0,
  },
  {
    id: "quote-docs",
    name: "Quotes and Ship Docs",
    role: "Quotations and CI/PL follow-up files",
    status: "idle",
    tone: "safe",
    load: 0,
    currentTask: "ready for quotes and CI/PL files",
    queue: 0,
  },
  {
    id: "follow-up-plan",
    ...
    tone: "safe",
    load: 0,
    currentTask: "ready for next-step planning",
    queue: 0,
  },
  {
    id: "approval-gates",
    ...
    tone: "pending",
    load: 75,
    currentTask: "3 customer-facing items waiting for review",
    queue: 3,
  },
  {
    id: "jaden-runtime",
    ...
    tone: "safe",
    load: 0,
    currentTask: "all automated tasks are clear",
    queue: 0,
  },
];
  ...
  amphenol: {
    ...
    messages: [
      ...
      },
      {
        ...
        body: [
          ...
          "Confirmation is required before any external customer-facing send.",
        ],
      },
      {
        id: "msg-wilson",
    ...
    analysis: [
      ...
      },
      {
        ...
        body:
          "Confirm the counter-offer with LME clause. The 8% discount stays above floor and the quarterly index review protects future batches. Losing this account risks spillover into other Amphenol plants.",
...
> = {
  en: {
    copy: {
      topBar: {
        ...
        activeAgents: (count) => `${count} task updates`,
        feedReconnecting: "activity stream reconnecting",
        sessionEvents: (count) => `${count} recent activities`,
      },
      language: {
        english: "EN",
        chinese: "中文",
      ...
      timeline: {
        ...
        openFocusMode: "Review",
      },
      commandCenter: {
        title: "To-Do Plan",
        meta: "Next actions, review items, task progress",
      ...
      focus: {
        ...
        humanApprovalRequired: "needs confirmation",
        emailThread: "Email Thread",
        aiAnalysis: "Deal Review",
        aiAnalysisMeta: "price, competitor, margin, next step",
        draftEditor: "Customer Draft",
        draftEditorMeta: "send after confirmation",
        subject: "Subject",
        approvalGate: "Confirmation Needed",
        blocked: "waiting",
        approvalGateBody:
          "Jaden can draft, score, and recommend. Nothing customer-facing happens until you confirm the final draft in this view.",
        approveSend: "Confirm & Send",
        saveDraft: "Save Draft",
        regenerate: "Regenerate with AI",
        reject: "Reject",
        sendGuardrail:
          "Confirmation is required before any customer-facing send. In safe mode, this records the decision without sending email.",
        collapsedMessages:
      ...
      approvalStates: {
        ...
        "approved-by-wilson": "confirmed",
        "draft-saved": "draft saved",
        "ai-regenerated": "rewritten by AI",
        "rejected-by-wilson": "rejected",
      },
      regeneratedNote:
        "Note: Rewritten for a firmer partnership tone. Confirm the price floor before sending.",
    },
    domainAccounts,
    timelineEvents,
    approvalRequests,
  ...
  zh: {
    copy: {
      topBar: {
        title: "Super Sales Agent",
        activeAgents: (count) => `${count} 项任务动态`,
        feedReconnecting: "动态同步重连中",
        sessionEvents: (count) => `${count} 条近期动态`,
      },
      language: {
        english: "EN",
        chinese: "中文",
      ...
      focus: {
        ...
        blocked: "待确认",
        approvalGateBody:
          "Jaden 可以起草、评分和给出建议，但在你确认最终草稿之前，不会执行任何客户可见动作。",
        approveSend: "确认并发送",
        saveDraft: "保存草稿",
        regenerate: "让 AI 重写",
        reject: "拒绝",
        sendGuardrail: "任何客户可见发送都必须先经过确认。本演示只在本地记录确认状态。",
      ...
      approvalStates: {
        ...
        "approved-by-wilson": "已确认",
        "draft-saved": "草稿已保存",
        "ai-regenerated": "AI 已重写",
        "rejected-by-wilson": "已拒绝",
      },
    ...
    domainAccounts: [
      ...
      },
      {
        ...
        agentStatus: "已起草还盘",
        lastTouch: "3分钟前",
        nextAction: "客户可见邮件发送前需要 Wilson 确认",
      ...
      },
      {
        ...
        summary: "AI 在价格确认后完成端到端流程。预计 2026-06-15 交付。",
        tags: ["PO 已确认", "生产", "单证"],
      },
      {
        id: "market-intel",
    ...
    approvalRequests: [
      {
        ...
        risk: "中等毛利风险",
        due: "现在",
        recommendation: "确认 $0.916/m 的 8% 折扣，并加入季度 LME 复核。",
        guardrail: "你确认前，外发邮件已被阻断。",
      },
      {
        id: "molex-retention",
        dealId: "molex",
        ...
        risk: "竞品低价截单",
        due: "今天 16:00",
        recommendation: "让 AI 准备组合报价，发送前复核。",
      ...
      },
      {
        ...
        risk: "低",
        due: "铜价检查后",
        recommendation: "如果 LME 保持在 +3% 区间内，确认报价包。",
        guardrail: "报价 PDF 生成仅限本地工作台演示。",
      },
    ],
    activeAgents: [
      {
      ...
      amphenol: {
        ...
        analysis: [
          ...
          },
          {
            title: "建议",
            body:
              "确认带 LME 条款的还盘。8% 折扣仍高于底价，季度指数复核可以保护后续批次毛利。若失去该客户，可能影响 Amphenol 其他工厂的合作机会。",

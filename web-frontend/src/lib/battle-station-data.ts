...
export const activeAgents: ActiveAgent[] = [
  ...
  },
  {
    ...
    tone: "pending",
    load: 75,
    currentTask: "3 item(s) waiting for operator review",
    queue: 3,
  },
  {
    id: "jaden-runtime",
    ...
    tone: "safe",
    load: 0,
    currentTask: "worker queue is clear",
    queue: 0,
  },
];
...
export const moduleLinks = [
  ...
  { label: "Ship Docs", href: "/documents", hotkey: "D" },
...
> = {
  en: {
    copy: {
      ...
      commandCenter: {
        title: "To-Do Plan",
        meta: "Next actions, approvals, background progress",
        ...
        activeAgents: "Background Progress",
        taskUnit: "tasks",
      },
      quickCommand: {
      ...
      focus: {
        ...
        blocked: "blocked",
        approvalGateBody:
          "JadenOS may draft, score, and recommend. It will not take any customer-facing action until the operator approves the final draft in this view.",
  ...
  zh: {
    copy: {
      ...
      focus: {
        ...
        blocked: "已阻断",
        approvalGateBody:
          "JadenOS 可以起草、评分和给出建议，但在操作员明确批准最终草稿之前，不会执行任何客户可见动作。",
        approveSend: "批准并发送",
        saveDraft: "保存草稿",
        regenerate: "让 AI 重写",
        reject: "拒绝",
    ...
    moduleLinks: [
      ...
      { label: "出货文件", href: "/documents", hotkey: "D" },

...
- **配置**: `/path/to/your/.openclaw/workspace/xiaoman-okki/api/config.json`
- **客户端**: `/path/to/your/.openclaw/workspace/xiaoman-okki/api/okki_client.py`
...
```bash
# 查询客户列表
python3 /path/to/your/.openclaw/workspace/xiaoman-okki/api/okki_client.py list_companies

# 查询客户详情
python3 /path/to/your/.openclaw/workspace/xiaoman-okki/api/okki_client.py get_company <company_id>

# 查询跟进动态
python3 /path/to/your/.openclaw/workspace/xiaoman-okki/api/okki_client.py list_trails <company_id>
```
...
3. Token 自动缓存，过期自动刷新
  ...
  <location>/path/to/your/.openclaw/workspace/skills/okki</location>

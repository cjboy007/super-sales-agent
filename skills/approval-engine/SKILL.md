...
`/path/to/your/.openclaw/workspace/skills/approval-engine/`
...
```javascript
const engine = require('/path/to/your/.openclaw/workspace/skills/approval-engine/src/approval-engine');
...
*/15 * * * * node -e "
  const engine = require('/path/to/your/.openclaw/workspace/skills/approval-engine/src/approval-engine');
  const detector = require('/path/to/your/.openclaw/workspace/skills/approval-engine/src/exception-detector');
...
```bash
# 运行冒烟测试
bash /path/to/your/.openclaw/workspace/skills/approval-engine/test/smoke-test.sh
```

...
description: '客户开发闭环追踪，发送记录 + 回复匹配 + 效果分析'
metadata:
  {
...
```bash
# 切换到 skill 目录
cd /path/to/your/.openclaw/workspace/skills/campaign-tracker
```
...
```
/path/to/your/.openclaw/workspace/skills/campaign-tracker/
...
const emailSkillPath = '/path/to/your/.openclaw/workspace/skills/imap-smtp-email';

// reply-matcher.js 使用 IMAP 收件箱
const imapConfig = require('/path/to/your/.openclaw/workspace/skills/imap-smtp-email/.env');

// 客户匹配使用 OKKI 向量搜索
const vectorSearch = '/path/to/your/.openclaw/workspace/vector_store/okki_vector_search_v3.py';
```
